        ...
        <div className="flex flex-col lg:flex-row gap-8">
          <div className="flex-1">
            ...
            <div className="flex space-x-4">
              ...
              <button className="px-4 py-2 px-4 py-2 text-gray-600 hover:text-blue-600 transition-colors">Educação</button>
              <button className="px-4 py-2 px-4 py-2 text-gray-600 hover:text-blue-600 transition-colors">Saúde</button>
            </div>
          </div>
        </div>
      </main>
