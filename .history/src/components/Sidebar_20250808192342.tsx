    ...
    return (
        <aside className="lg:w-80">
            ...
            <div className="bg-gradient-to-br from-blue-600 to-blue-700 text-white rounded-lg p-6">
                <h3 className="text-lg font-semibold mb-2">Fique atualizado</h3>
                <p className="text-blue-100 mb-4 text-sm">Receba as últimas notícias em sua caixa de entrada diariamente.</p>
                <div className="space-y-3">
                    <input
                        type="email"
